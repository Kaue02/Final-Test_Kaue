...
public class Twelve extends Fighter {

	private static final int META_ESPECIAL = 5;
		
	public Twelve(String name, int power, int life, Special special) {
		super(name = "Twelve", power = 7, life = 80, special);
		this.special = new Special(" Death Blow", 9);
	}
